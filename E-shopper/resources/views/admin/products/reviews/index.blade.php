            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <a href="{{route('review.create')}}" class="btn btn-primary addBtn">Thêm đánh giá
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <td class="project-state">
                                        <input data-id="{{$review->id}}" class="toggle-class" type="checkbox"
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{route('review.edit',$review->id)}}">
                                            ...
                                            @endcan
                                            @can('review_delete')
                                        <a class="btn btn-danger btn-sm" href="{{route('review.delete',$review->id)}}">
