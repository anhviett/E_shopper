...
@section('title'){{'Styles'}}@endsection
@section('content')
    {{--wrapper--}}
    <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <a href="{{route('style.create')}}" class="btn btn-primary addBtn">Thêm thể loại
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <td class="project-state">
                                        <input data-id="{{$style->id}}" class="toggle-class" type="checkbox"
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-danger btn-sm" href="{{route('style.delete',$style->id)}}">
